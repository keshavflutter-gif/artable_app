...
class MockData {
  ...
  static final REELS = [
  { 'id': 'r1', 'title': 'Freestyle finale',    'creator': 'Maya R.',  'handle': '@dance_hero',   'category': 'Dance',   'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1547153760-18fc86324498?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=dance_hero',  'views': '1.2M',
  ...
  { 'id': 'r2', 'title': 'Crowd-work bit',      'creator': 'Theo B.',  'handle': '@funny_banda',  'category': 'Comedy',  'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=funny_banda', 'views': '856K',
  ...
  { 'id': 'r3', 'title': 'Sunset flexibility',  'creator': 'Leo M.',   'handle': '@fit_beat',     'category': 'Fitness', 'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=fit_beat',    'views': '1.5M',
  ...
  { 'id': 'r4', 'title': 'High note challenge', 'creator': 'Aria N.',  'handle': '@music_wave',   'category': 'Singing', 'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=music_wave',  'views': '980K',
  ...
  { 'id': 'r5', 'title': 'Card trick reveal',   'creator': 'Ravi K.',  'handle': '@magician.07',  'category': 'Magic',   'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=magician07',  'views': '670K',
  ...
  { 'id': 'r6', 'title': 'Canvas in progress',  'creator': 'Nina P.',  'handle': '@art_life',     'category': 'Art',     'verified': true, 'imageUrl': 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=600&q=80', 'videoUrl': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', 'avatarUrl': 'https://i.pravatar.cc/100?u=art_life',    'views': '540K',
  ...
  static final Map<String, List<Map<String, dynamic>>> COMMENTS = {
  'r1': [
  ...
  static final REPORT_REASONS = [
  { 'id': 'spam',         'label': 'Spam' },
  { 'id': 'inappropriate', 'label': 'Inappropriate Content' },
  { 'id': 'copyright',    'label': 'Copyright Issue' },
  { 'id': 'other',        'label': 'Other' },
];
  static final QUICK_ACTIONS = [
  ...
  static final HOME_ACTIVE_CHALLENGES = [
  ...
  static final MEGA_PROMO_BANNERS = [
  {
  ...
  static final List<Map<String, dynamic>> DRAFTS = [
  ...
  static final RECENT_SEARCHES = ['Dance challenge', '@funny_banda', 'Singing tips', 'Weekly Vocal Showdown'];
  static final POPULAR_SEARCHES = ['Dance', 'Singing', 'Comedy', 'Fitness', 'Magic', 'Art', 'Challenges', 'Rewards'];
  ...
  static final CURRENT_USER_ID = 'u7';
  static final MY_VIDEOS = [
  ...
  static final CREATOR_LEVELS = ['Beginner', 'Rising Star', 'Influencer', 'Champion'];
  static final RATING_DISTRIBUTION = [2, 3, 6, 10, 18, 34, 58, 91, 64, 22];
  static final RECENT_PERFORMANCE = [
  ...
  static final REFERRAL_SUMMARY = { 'code': 'ARTABLE2026', 'totalInvites': 18, 'joinedUsers': 9, 'rewardsEarned': '₹45', 'pendingRewards': '₹15' };
  static final REFERRAL_MILESTONE = { 'current': 9, 'next': 10, 'nextReward': '₹10 Bonus' };
  static final REFERRAL_LIST = [
  ...
  static final MUSIC_LIBRARY_TRACKS = [
  ...
  static final ACTIVITY_SUMMARY = { 'likes': 142, 'comments': 38, 'ratings': 96, 'entries': 12, 'rewardsEarned': '₹1,650' };
  static final ACTIVITY_LOG = [
  ...
  static final NOTIFICATION_SETTINGS = [
