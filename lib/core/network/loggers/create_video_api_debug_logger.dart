...
class CreateVideoApiDebugLogger {
  CreateVideoApiDebugLogger._();
  ...
  static void logRequest({
    ...
    debugPrint('=== CREATE VIDEO API REQUEST ===');
    debugPrint('Method: $method');
    debugPrint('URL: $url');
    debugPrint('Headers: ${_maskHeaders(headers)}');
    if (body != null && body.isNotEmpty) {
      debugPrint('Body: ${_maskJsonString(jsonEncode(body))}');
    }
  }
  ...
  static void logResponse({
    ...
    debugPrint('=== CREATE VIDEO API RESPONSE ===');
