...
class ChallengeDetailApiDebugLogger {
  ChallengeDetailApiDebugLogger._();
  ...
  static void logRequest({
    ...
    debugPrint('=== CHALLENGES API REQUEST ===');
  ...
  static void logResponse({
    ...
    debugPrint('=== CHALLENGES API RESPONSE ===');
    debugPrint('CHALLENGE DETAIL API RESPONSE');
